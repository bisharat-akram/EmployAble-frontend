export const Data = {
  ...
  LandingPageSignUpButton: "Sign up for jobs",
  ...
  EmployersData: `Employers, we invite you to embark on a transformative journey towards fostering inclusive and socially responsible hiring practices.
    ...
    `,
  JobSeekerButton: "Unlock Your Second Chance – Sign Up Today!",
  EmployersButton: "Transform lives – Recruit Second Chance Talent",
};
